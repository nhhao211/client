...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    // Defer heavy canvas work until browser is idle to improve INP
    const initCanvas = () => {
    ...
    // This improves FID/INP by not blocking main thread during page load
    if ('requestIdleCallback' in window) {
      (window as any).requestIdleCallback(initCanvas, { timeout: 1000 });
    } else {
