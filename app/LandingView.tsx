...
import { ArrowLeft, ArrowRight, Sparkles, FileText, Zap } from "lucide-react";
import dynamic from "next/dynamic";

// Lazy load canvas animation to improve LCP
...
export default function LandingView({ isAuthenticated }: LandingViewProps) {
  return (
    <>
      {/* Animated Background */}
      <AnimatedBackground />
